...
interface LikeRepository : JpaRepository<Like, Long> {
    ...
    fun existsByUserIdAndGifId(userId: Long, gifId: Long): Boolean
    ...
    fun findByUserId(@Param("userId") userId: Long, pageable: Pageable): Page<Like>

    @Modifying
    @Transactional
    @Query("delete from Like l where l.user.id = :userId and l.gif.id = :gifId")
    fun deleteByUserIdAndGifId(@Param("userId") userId: Long, @Param("gifId") gifId: Long): Int
}
