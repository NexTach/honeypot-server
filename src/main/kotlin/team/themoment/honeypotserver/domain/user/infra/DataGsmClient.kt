...
class DataGsmClient(
    ...
    fun buildLoginUrl(state: String, codeVerifier: String): String {
        val builder = dataGsmOAuthClient.createAuthorizationUrl(dataGsmProperties.redirectUri)
            .state(state)
            .scope("self:read")
    ...
    fun exchangeCodeForToken(code: String, codeVerifier: String): String {
        val tokenResponse = dataGsmOAuthClient.exchangeCodeForToken(
            code,
